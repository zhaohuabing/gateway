...
type Resources struct {
	// WithErrors indicates whether the resources contain errors that may affect xDS generation.
	...
	WithErrors bool `json:"withErrors,omitempty" yaml:"withErrors,omitempty"`
